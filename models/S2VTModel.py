...
class S2VTModel(nn.Module):
    ...
    def forward_embedding(self, vid_feats):
        ...
        return output2.squeeze(1), state1, state2

    def forward_loss(self, vid_feats, state1, state2, target_variable=None, mode='train', opt={}):
        batch_size, n_frames, _ = vid_feats.shape
        padding_frames = Variable(vid_feats.data.new(batch_size, 1, self.dim_vid)).zero_()
        #state1 = None
        #state2 = None
