...
def main():
    ...
    parser.add_argument('--if_IOU', action='store_true',
                        help='if_IOU')
...
def train(opt, train_loader, model, epoch, val_loader, best_rsum):
    ...
    for i, train_data in enumerate(train_loader):
        ...
        if opt.max_violation and model.Eiters >= 500:
            model.criterion.max_violation = opt.max_violation
...
def validate(opt, val_loader, model):
    ...
    currscore = r1 + r5  + r1i + r5i + r10i + r10
